        ...
        <main className="min-h-[calc(100vh-4rem)]">
              ...
              <section className="space-y-4">
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    ...
                    className="px-6 py-3 rounded-lg text-base font-medium bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-lg shadow-green-500/20"
                  >
          ...
          {step === "arena" && (
            <div className="flex">
              ...
              {/* Main Content Area */}
              <div className="flex-1 px-8 py-6 space-y-6 bg-gradient-to-br from-arena-bg to-zinc-950 min-h-screen">
                {/* Header */}
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="text-4xl font-extrabold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2">
                      AI Model Comparison
                    </h1>
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg text-base border border-zinc-700 hover:border-green-500/50 hover:bg-zinc-900/50 transition-colors"
                  >
                    ← API Keys
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-base text-zinc-400 italic">
                      💡 Select models for comparison from the left sidebar
                    </p>
                    <button
                      onClick={handleRun}
                      disabled={!prompt.trim() || !selectedModels.length || runLoading}
                    className="px-8 py-3 rounded-xl text-base font-bold bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 hover:from-green-600 hover:via-emerald-600 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-xl shadow-green-500/30 hover:shadow-green-500/40 transform hover:scale-105"
                  >
                ...
                <section>
                  {selectedModels.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 border-2 border-dashed border-zinc-800 rounded-2xl bg-black/20">
